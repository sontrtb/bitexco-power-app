...
function DatePickerUi(props: DatePickerUiProps) {
    const { value, onChange, disable, label, required } = props;
        ...
        <View style={styles.root}>
            ...
            <TouchableOpacityUi disabled={disable} onPress={() => setModalVisible(true)}>
                <TextInputUi
                    ...
                    style={{ color: color.text, borderColor: isModalVisible ? color.primary : color.borderColor, paddingHorizontal: 12 }}
